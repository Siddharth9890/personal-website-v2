...
const shortDescription =
  "I have also recently launched a npm package that helps you to build your projects in a simpler way build using nodejs.";

function AboutMe() {
  return (
    <section id="about" className="relative py-16 bg-navy overflow-hidden">
